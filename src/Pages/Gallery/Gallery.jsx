...
const Gallery = () => {
    ...
    return (
        <main className="min-h-screen bg-orange-50/40 pb-16">
            <Helmet>
                <title>Gallery - Hidden Pearl</title>
            </Helmet>
            ...
            <section className="mx-auto px-4 pt-12 sm:px-6 lg:px-8">
                <p className="mx-auto mb-8 max-w-2xl text-center text-gray-600">
                    A taste of the dishes, ingredients, and warm moments from
                    Hidden Pearl. Select an image to view it in full.
                </p>
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 sm:gap-5">
                    {galleryImages.map((image, index) => (
                        <button
                            ...
                            className="group relative overflow-hidden rounded-xl bg-gray-200 text-left focus:outline-none focus:ring-4 focus:ring-orange-300"
                        >
                            <img
                                src={image.src}
                                alt={image.alt}
            ...
            {selectedImage && (
                ...
                >
                    <button
                        type="button"
                        onClick={() => setSelectedIndex(null)}
                        className="absolute right-5 top-5 rounded-full bg-white/15 px-4 py-2 text-2xl text-white hover:bg-white/25"
                    ...
                    <button
                        ...
                        className="absolute left-3 rounded-full bg-white/15 px-4 py-3 text-3xl text-white hover:bg-white/25 sm:left-8"
                    ...
                    <button
                        ...
                        className="absolute right-3 rounded-full bg-white/15 px-4 py-3 text-3xl text-white hover:bg-white/25 sm:right-8"
